...
$string['comment:template:package_submitted'] = 'Hallo,<br /><br />Ich habe gerade die Ressource "{$a->title}" zur Freigabe übermittelt!<br /><br />Liebe Gr&uuml;&szlig;e';
$string['comment:template:etapa_vorschlag_created'] = 'Hallo,<br /><br />neuer eTapa Vorschlag "{$a->title}".<br /><br />Liebe Gr&uuml;&szlig;e';
$string['comment:template:etapa_vorschlag_confirmed'] = 'Hallo,<br /><br />der eTapa Vorschlag "{$a->title}" wurde bestätigt!<br /><br />Liebe Gr&uuml;&szlig;e';
...
$string['default_publish_as'] = 'an das Redaktionsteam weiterleiten';
...
$string['defaultroleteacher'] = 'Standardrolle von Kurseditoren';
...
$string['course_role_package_viewing'] = 'Kursrolle: unveröffentliches Paket einsehen';
...
$string['removing_package_course'] = 'Entferne Kurs zum Ressource #{$a->id} {$a->title}';
...
$string['self_unenrol_isingroup_text'] = '<strong>Achtung:</strong> Sie können sich nur aus einem Kurs austragen, wenn Sie keiner Gruppe angehören. Als Lernbegleiter/in <a href="{$a->url}">löschen Sie bitte zuerst alle Gruppen</a>, als Lernende/r kontaktieren Sie bitte Ihre Lehrperson.';
$string['self_unenrol_isingroup_multiple'] = 'Sie gehören derzeit zu folgenden Gruppen:';
$string['self_unenrol_isingroup_single'] = 'Sie gehören derzeit zu folgender Gruppe:';
...
$string['author_editing_permission'] = 'Schreibrechte für Urheber/in';
$string['type'] = 'Typ';
