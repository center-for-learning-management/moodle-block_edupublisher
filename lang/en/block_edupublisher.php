...
$string['comment:template:package_submitted'] = 'Hello,<br /><br />I just submitted the package "{$a->title}" for release!<br /><br />Kind regards';
$string['comment:template:etapa_vorschlag_created'] = 'Hello,<br /><br />new eTapa proposal "{$a->title}".<br /><br />Kind regards';
$string['comment:template:etapa_vorschlag_confirmed'] = 'Hello,<br /><br />the eTapa proposal "{$a->title}" was confirmed!<br /><br />Kind regards';
...
$string['default_publish_as'] = 'Publish';
$string['default_schoollevels'] = 'Schoollevels';
...
$string['default_subjectareas'] = 'Subjectareas';
...
$string['course_role_package_viewing'] = 'Courserole: view unpublished package';
$string['course_role_package_viewing:description'] = '';
...
$string['eduthekneu_contenttypes'] = 'Contenttypes';
$string['eduthekneu_purposes'] = 'Purposes';
...
$string['etapas_status_eval'] = 'Peer reviewed';
$string['etapas_status_inspect'] = 'Inspection needed';
$string['etapas_status_public'] = 'Needs peer review';
...
$string['self_unenrol_isingroup_text'] = '<strong>Attention:</strong> you can only unenrol from a course if you are not member of any group. As a teacher, please <a href="{$a->url}">remove all groups</a> before doing so, as a student please ask your teacher.';
$string['self_unenrol_isingroup_multiple'] = 'You are enrolled in the following groups:';
$string['self_unenrol_isingroup_single'] = 'You are enrolled in the following group:';
$string['send_email_failed'] = 'Sending an email to "{$a->email}" failed.';
$string['settings'] = 'Settings';
$string['star_multiple'] = '{$a->stars} stars';
$string['star_none'] = 'No rating';
$string['star_single'] = '1 star';
...
$string['author_editing_permission'] = 'Write permission to author';
$string['type'] = 'Type';
$string['votes'] = 'Vote(s)';
